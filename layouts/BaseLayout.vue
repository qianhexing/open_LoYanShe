      ...
      <div class="base-header-wrap">
        <div class="base-header">
          ...
          <div class="base-nav">
            ...
            <nuxt-link :to="`/lolitaWiki/`" title="洛丽塔百科" class="base-nav-list" active-class="active">
              <nav>百科</nav>
            </nuxt-link>
    ...
    hasNotice () {
      hasNotice()
        .then((res) => {
          const { code, data } = res
          if (code === 200) {
            this.has_notice = data
            console.log(this.has_notice)
          }
        })
    }
  }
